 ...
 * @since 0.0.1
 */
public class NotFoundException extends GlobalRestClientException {

    public NotFoundException(String code, String status, String error, String message, String path, Object details) {
