 ...
 * @since 0.0.1
 */
public class InternalServerErrorHandlingStrategyImpl extends RestClientErrorHandlingStrategyBase{

    public InternalServerErrorHandlingStrategyImpl(Response response) {
        super(
                HttpExceptionErrorCodeEnum.ERROR_500_INTERNAL_SERVER_ERROR.getCode(),
