 ...
 * @since 0.0.1
 */
public class BadRequestErrorHandlingStrategyImpl extends RestClientErrorHandlingStrategyBase {

    public BadRequestErrorHandlingStrategyImpl(Response response) {
        super(
            HttpExceptionErrorCodeEnum.ERROR_400_BAD_REQUEST.getCode(),
    ...
    public Exception handle(Response response) {
        // Personaliza el manejo de BadRequestException y agrega detalles específicos si es necesario.
