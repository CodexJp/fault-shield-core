 ...
 * @since 0.0.1
 */
public class ServiceUnavailableErrorHandlingStrategyImpl extends RestClientErrorHandlingStrategyBase{

    public ServiceUnavailableErrorHandlingStrategyImpl(Response response) {
        super(
                HttpExceptionErrorCodeEnum.ERROR_503_SERVICE_UNAVAILABLE.getCode(),
