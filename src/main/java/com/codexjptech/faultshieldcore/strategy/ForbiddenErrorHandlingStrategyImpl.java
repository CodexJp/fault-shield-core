 ...
 * @since 0.0.1
 */
public class ForbiddenErrorHandlingStrategyImpl extends RestClientErrorHandlingStrategyBase{

    public ForbiddenErrorHandlingStrategyImpl(Response response) {
        super(
                HttpExceptionErrorCodeEnum.ERROR_403_FORBIDDEN.getCode(),
