...
/**
 * Handler para excepciones de aplicación en tiempo de ejecución
 * <br/><br/>
 *
 ...
 * @since 0.0.1
 */
public class ApplicationExceptionHandlerImpl extends CustomExceptionHandlerUtil implements ICustomExceptionHandler{

    @Override
    public void handle(Throwable exception) {

        originalException = exception;
        globalApplicationException = (GlobalApplicationException) exception;
